...
public class GenericExample_04<T extends Comparable<T>> implements MinMax<T>{
	T[] values;
	GenericExample_04(T[] obj){
		values = obj;
	}
	...
	public static void main(String[] args) {
		...
		GenericExample_04<Integer> obj1 = new GenericExample_04<Integer>(arr);
